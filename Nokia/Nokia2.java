...
boolean messageSettingRunning = true;
...
boolean callCostSettingsRunning = true;
	...
	switch(menuFunctionsList){
		...
		while(phoneBookRunning){
			...
			case 8: System.out.println("Options"); 													
				while (optionsRunning){
					...
					case 0: optionsRunning = false; break;
			...
			case 0: phoneBookRunning = false; break;
			default: System.out.println("Invalid Input"); 
			}
			}	
			break;
		...
		case 2: System.out.println("Messages"); 
			...
			while(messagesRunning){
					...
					while(messageSettingRunning){
						...
						case 2: System.out.println("Common"); 
							...
							while(commonRunning){
								...
								case 0: commonRunning = false; break;
								default: System.out.println("Invalid Input"); 
							}
							}
							break;

						case 0: messageSettingRunning = false; break;
						default: System.out.println("Invalid Input");
					}
					}
					break;
				...
				case 0: messagesRunning = false; break;
				default: System.out.println("Invalid Input");
			}
			}
     			break;
			...
			while (callRegisterRunning){
				...
				case 5: System.out.println("Show call duration"); 
					...
					while(showCallDurationRunning){
						...
						case 0: showCallDurationRunning = false; break;
						default: System.out.println("Invalid Input");
					}
					}
					break;
				...
				case 6: System.out.println(" Show call costs"); 
					...
					while(showCallCostsRunning){
						...
						case 0: showCallCostsRunning = false; break;
						default: System.out.println("Invalid Input");
					}
					}
					break;
				...
				case 7: System.out.println("Call cost settings"); 
					...
					while(callCostSettingsRunning){
						...
						case 0: callCostSettingsRunning = false; break;
						default: System.out.println("Invalid Input");
					}
					}
					break;
		...
		case 5: System.out.println("Tones"); 
			...
			while(tonesRunning){
				...
				case 0: tonesRunning = false; break;
			...
			while (settingsRunning){
				...
				case 2: System.out.println("Phone settings"); 
					...
					while(phoneSettingsRunning){
						...
						case 0: phoneSettingsRunning = false; break;
						default: System.out.println("Invalid Input"); 
					}
					}
					break;
				...
				case 3: System.out.println("Security settings"); 
					...
					while(securitySettingsRunning){
						...
						case 0: securitySettingsRunning = false; break;
						default: System.out.println("Invalid Input"); 
					}
					}
					break;
				...
				case 0: settingsRunning = false; break;
				default: System.out.println("Invalid Input"); break; 
				}
				}
				break;
		...
		case 11: System.out.println("Clock"); 
			...
			while (clockRunning){
				...
				case 0: clockRunning = false; break;
				default: System.out.println("Invalid Input"); 
			}
			}
			break;
